              ...
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
               ...
               <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Email" name="email" value="{{ old('email') }}" aria-label="Email" aria-describedby="email-addon" required  autocomplete="email" autofocus>
                  </div>
                  <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">Password</label>
                    <input type="password" class="form-control" name="password" placeholder="Password" aria-label="Password" aria-describedby="password-addon" required autocomplete="current-password" >
                  </div>
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-medium fs-3" href="../main/authentication-forgot-password.html">Forgot Password ?</a>
                     ...
                     <button type="submit" class="btn btn-info btn bg-gradient-info w-100 mt-4 mb-0">
                                    {{ __('Login') }}
                                </button>
